    ...
    <footer className="bg-[#f9f9ff] text-gray-800 py-10 px-4">
      <div className="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-5 gap-8">
        ...
        <div className="md:col-span-2">
          <h3 className="text-xl font-semibold mb-2">Shop Non-Stop on Paridhan Sangrah</h3>
          <p className="text-sm mb-2">Trusted by families across India</p>
          <p className="text-sm mb-4">Men • Women • Kids | Quality You Can Wear</p>
        ...
        <div>
          ...
          <address className="text-sm not-italic leading-6">
            Paridhan Sangrah Pvt. Ltd.<br />
            Email: <a href="mailto:support@paridhansangrah.com" className="text-blue-600">support@paridhansangrah.com</a>
          </address>
